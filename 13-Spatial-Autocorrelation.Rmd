...
## Librarys needed for this tutorial. 
...
# Set color scales
Income_scale <- tm_scale_intervals(values = "brewer.blues", style = "jenks")
...
tm_shape(MyData) + 
  tm_polygons(
    fill        = "Income",
    fill.scale  = Income_scale,
    fill_alpha  = 0.5,
    fill.legend = tm_legend("Maine average income per county")
  ) 
