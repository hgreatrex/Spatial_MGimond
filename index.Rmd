...
<u>2025 UPDATE:</u>
<ul><li>This version sees a full re-write of Part2: Spatial Analysis. The chapters a better aligned with the the order in which topics are covered in the course with the overarching theme being the distinction between 1st order and 2nd order spatial processes.</li>
<li> A new chapter on modeling spatial trends is added to Part2</li></ul>
